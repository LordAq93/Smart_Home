...
const CATALOG=[
 ...
 {id:'temp',g:'△',c:'climate',img:'images/temp.svg',price:59,
  ...
  ar:['حساس حرارة الغرفة',
      'يجعل المكيّف يقيس حرارة الغرفة التي تنام فيها بدلاً من حرارة الممر.',
      'يجعل المكيّف يقيس حرارة الغرفة التي تنام فيها بدلاً من الممر الذي رُكّب فيه المنظّم.'],
 ...
 {id:'switch',g:'◫',c:'lighting',img:'images/switch.svg',price:189,featured:true,
  ...
  ar:['مفتاح جداري بثلاثة أزرار',
      'يُركّب مكان الغطاء دون تغيير التمديدات، ويعمل يدوياً عند انقطاع الإنترنت.',
      'يُركّب مكان الغطاء الحالي دون تغيير التمديدات، ويعمل يدوياً كالمعتاد عند انقطاع الإنترنت.'],
 ...
 {id:'plug',g:'◈',c:'power',img:'images/plug.svg',price:89,was:129,flag:'pop',featured:true,demo:'plug',
  ...
  ar:['أقباس ذكية ١٦ أمبير',
      ...
      'أقباس بريطانية تتحكّم بها من جوالك وتحسب كل واط يمرّ خلالها. تتحمّل فريزر أو مكيّف شبّاك، وليست للمصابيح فقط.'],
...
const SPECLAB={compat:{en:'Works with',ar:'يتوافق مع'},
 ...
 offline:{en:'Works offline',ar:'يعمل بدون إنترنت',shortEn:'Offline',shortAr:'بدون نت'},
...
/* Questions that apply to every product, shown after the ones that are
